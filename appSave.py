    ...
    if not os.path.exists(temp_pptx_path):
        ...
        try:
            ...
            if image_paths:
                ...
                download_button = st.button("Download All Images as ZIP")

                if download_button:
                    # Prepare ZIP file with all images
                    ...
                    st.markdown(get_binary_file_downloader_html(zip_path, zip_filename, 'Download ZIP'), unsafe_allow_html=True)
...
if __name__ == "__main__":
    ...
    st.write("""
        ...
        - Click **Download All Images as ZIP** to save all converted images to your PC.
    """)
